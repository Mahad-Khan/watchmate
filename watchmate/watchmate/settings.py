...
SECRET_KEY = 'django-insecure-xa^tbi2yu6@x4697251@=fx%cf37mmd73dhc^ni7s#6os@41ia'
...
INSTALLED_APPS = [
    ...
    'django_filters',            ## this library only works with generic views
]
...
# Global settings
REST_FRAMEWORK = {                                    #### this setting will apply on each and every class
